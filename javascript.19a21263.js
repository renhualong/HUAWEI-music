...
var Swiper = /*#__PURE__*/_createClass(function Swiper(node) {
  ...
  if (!node) throw Error('需要传递需要绑定的DOM元素');
...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function renderSong() {
      ...
      var songObj = this.songList[this.currentIndex]; // console.log(this.root.querySelector('.header h1'))
      ...
      this.audio.onloadedmetadata = function () {
        return _this2.root.querySelector('.time-end').innerText = _this2.formateTime(_this2.audio.duration);
      };
    ...
    value: function locateLyric() {
      ...
      if (currentTime > nextLineTime && this.lyricIndex < this.lyricsArr.length - 1) {
        this.lyricIndex++;
        var node = this.root.querySelector('[data-time="' + this.lyricsArr[this.lyricIndex][0] + '"]');
        console.log(node);
        if (node) this.setLineToCenter(node);
        this.root.querySelectorAll('.panel-effect .lyric p')[0].innerText = this.lyricsArr[this.lyricIndex][1];
        this.root.querySelectorAll('.panel-effect .lyric p')[1].innerText = this.lyricsArr[this.lyricIndex + 1] ? this.lyricsArr[this.lyricIndex + 1][1] : '';
      }
    }
  }, {
    key: "playPrevSong",
    ...
    value: function setLineToCenter(node) {
      console.log(node);
      var offset = node.offsetTop - this.root.querySelector('.panels').offsetHeight / 2;
      offset = offset > 0 ? offset : 0;
      console.log('11111111');
      console.log(offset);
      this.root.querySelector('.panel-lyrics .container').style.transform = "translateY(-".concat(offset, "px)");
      this.root.querySelectorAll('.panels .container p').forEach(function (node) {
...
},{"./icons.js":"src/javascript/icons.js","./Swiper":"src/javascript/Swiper.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
